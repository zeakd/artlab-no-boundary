...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Fluider, [{
    ...
    value: function simulate() {
      ...
      this.advect(this.u0y, this.u1y); // this.addMouseForce();
    ...
    value: function addPoint() {
      ...
      var dy = this.pointY - this.prevPointY; // console.log(this.pointX, this.prevPointX, this.pointY, this.prevPointY, dx, dy)
...
},{"./utils":"utils.js"}],"color/main.js":[function(require,module,exports) {
"use strict";
...
fluider.run();
var socket = (0, _socket.default)("http://localhost:4000");
socket.on('connect', function () {
  console.log('connect!');
});
socket.on('imageData', function (values) {
  updateCanvas(values); // console.log(values);
});
var colorStatus = [{
  color: '#ff3000',
  in: false
...
/*#__PURE__*/
function () {
  function Walker(x, y, vx, vy, ax, ay) {
    var duration = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 2;
  ...
  _createClass(Walker, [{
    ...
    value: function walk(cb) {
      ...
      this.intervalId = setInterval(function () {
        if (_this.duration < _this.sum) {
          clearInterval(_this.intervalId);
        }

        _this._walk(cb);

        _this.sum += _this.interval;
      }, this.interval * 1000);
    }
  }, {
    key: "stop",
...
function randomWalk() {
  var vx = (0, _utils.random)(50) - 25;
  var vy = (0, _utils.random)(50) - 25;
  var ax = (0, _utils.random)(50) - 25;
  var ay = (0, _utils.random)(50) - 25;
  var width = 128;
  var height = 128;
  var x = vx < 0 ? width + (0, _utils.random)(width / 50) : (0, _utils.random)(width / 50);
  var y = vy > 0 ? height + (0, _utils.random)(height / 50) : (0, _utils.random)(height / 50); // console.log(x, y, vx, vy, ax, ay)
...
function age(colors) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      delta = _ref$delta === void 0 ? 0.01 : _ref$delta;

  var aged = colors.map(function (_ref2) {
    var originColor = _ref2.originColor,
        prevRate = _ref2.rate;
    var rate = prevRate - delta;
  ...
  values.forEach(function (value, index) {
    ...
    if (value < 5000) {
      ...
      if (!colorStatus[index].in) {
        ...
        var color = (0, _utils.hexToRgb)(colorStatus[index].color);
        currentColors.push({
          color: color,
          originColor: color,
          rate: 1
        ...
        randomWalk();
      } else {// audioStates[index].audio.volume = volume;
      }
    }
  });
}
},{"socket.io-client":"../node_modules/socket.io-client/lib/index.js","../fluid":"fluid.js","../utils":"utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","color/main.js"], null)
//# sourceMappingURL=/main.26f5fac4.map